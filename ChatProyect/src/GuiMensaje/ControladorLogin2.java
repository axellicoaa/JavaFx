...
public class ControladorLogin2
{
	...
	public ControladorLogin2(int vboxspacing) 
	{
		...
		BackgroundFill fondologin = new BackgroundFill(Color.WHITE, null, null);
		BackgroundFill fondoiz= new BackgroundFill(Color.DODGERBLUE, null, null);
        
		
		fondo.setBackground(new Background(fondologin));
		fondo.setStyle("-fx-background: transparent;-fx-background-color: transparent;-fx-background-image: url('ImagenesLogin/Devax.jpg'); -fx-background-repeat: stretch;-fx-background-size: AUTO AUTO; -fx-background-position: center center;");
		
		
		panelDer.setBackground(new Background(fondologin));
		vbox.setBackground(new Background(fondoiz));
	...
	public void visible() 
	{
		...
		BackgroundFill fondologin = new BackgroundFill(Color.DODGERBLUE, null, null);
		panelDer.setBackground(new Background(fondologin));
