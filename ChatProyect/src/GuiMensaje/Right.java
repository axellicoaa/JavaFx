...
public class Right 
{
	...
	public void messageUsuario(String foto, String message, LocalDateTime datetime) {
	...
	public void styles() {
		...
		mensaje.setStyle("-fx-font-family: 'Bookshelf Symbol 7';\r\n"
				+ "	-fx-text-alignment: justify;\r\n"
				+ "	-fx-max-width: 350px;\r\n"
				+ "	-fx-wrap-text: true;\r\n"
				+ "	-fx-font-size: 100%;");
		
		fecha.setStyle("-fx-font-family: 'Bookshelf Symbol 7';\r\n"
